...
public class WaveView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mColor=typedArray.getColor(R.styleable.Wave_View_wave_color, Color.LTGRAY);
        mWaveNum=typedArray.getInt(R.styleable.Wave_View_wave_num,2);
        mWaveLen=typedArray.getDimension(R.styleable.Wave_View_wave_len,1000f);
        mDuringTime=typedArray.getInt(R.styleable.Wave_View_duration_time,1000);
